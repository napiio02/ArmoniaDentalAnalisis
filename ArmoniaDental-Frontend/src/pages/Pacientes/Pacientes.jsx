...
const Pacientes = () => {
  ...
  const toggleEstadoPaciente = (id) => {
    setStatusLoading(id);
    setTimeout(() => {
      setPacientes((prev) =>
        prev.map((p) => (p._id === id ? { ...p, activo: !p.activo } : p)),
      );
                        ...
                        >
                          ...
                          <td className="px-5 py-4">
                            ...
                            paciente.alergias !== "Ninguna" ? (
                              <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-xs font-semibold bg-[#ffddb820] text-[#855300] border border-[#855300]/20">
                          ...
                          <td className="px-5 py-4">
                            <div className="flex items-center gap-2">
                              ...
                              <button
                                onClick={() =>
                                  toggleEstadoPaciente(paciente._id)
                                }
